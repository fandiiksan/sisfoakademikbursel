			...
			<div class="card-body col-md-6">
				<form action="" method="post" class="mt-5">
					<div class="form-group">
						...
						<textarea class="form-control" id="aspek" name="aspek" rows="5" placeholder="Isi Aspek ..." ><?= $asesmen['aspek'] ?></textarea>
						<small class="form-text text-danger"><?= form_error('aspek') ?></small>
					</div>
					<div class="form-group">
						<label for="deskripsi">Deskripsi</label>
						<textarea class="form-control" id="deskripsi" name="deskripsi" rows="5" placeholder="Isi Deskripsi ..."><?= $asesmen['deskripsi'] ?></textarea>
